                  ...
                  {isOpen && (
                    <div className="px-4 pb-4 space-y-3 border-t border-mute dark:border-zinc-700 pt-3">
                      ...
                      {p.resources?.length > 0 && (
                        <div>
                          <p className="text-xs font-semibold text-mute uppercase tracking-wide mb-1">Learn more</p>
                          <div className="flex flex-col gap-1">
                            {p.resources.map((r) => (
                              <a
                                ...
                                className="text-xs text-primary dark:text-primary hover:underline flex items-center gap-1"
                              >
